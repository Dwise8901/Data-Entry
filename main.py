...
def enter_data():
    ...
    if accepted=="Accepted":
        ...
        if firstname and lastname:
            ...
            print("Title name: ", "Age: ", age, "Nationality: ", nationality)
...
tittle_label = tkinter.Label(user_info_frame, text="Title")
title_combobox = ttk.Combobox(user_info_frame, values=["", "Mr.", "Mrs.", "Dr.", "Miss.", "Dr.", "Engr."])
tittle_label.grid(row=0, column=2)
title_combobox.grid(row=1, column=2)

age_label = tkinter.Label(user_info_frame, text="Age")
age_spinbox = tkinter.Spinbox(user_info_frame, from_=18, to=120)
age_label.grid(row=2, column=0)
age_spinbox.grid(row=3, column=0)

nationality_label = tkinter.LabelFrame(user_info_frame, text="Nationality")
nationality_combobox = ttk.Combobox(user_info_frame, values=["Africa", "Antarctica", "Asia", "Ëurope", "North America", "Oceania", "South America"])
...
terms_frame.grid(row=2, column=0, sticky="news", padx=20, columnspan=20)
